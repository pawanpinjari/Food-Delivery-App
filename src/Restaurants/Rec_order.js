...
const Rec_order = (props) => {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:8000/rec_order',{},{
      headers: {
              ...
              data.map((e, i) => (
                <div key={i}>
                  <div className='order-main' >
                   ...
                   <div>
                   <div className='order-addr'><FaLocationDot />{e.bill_address.address} {e.bill_address.city} {e.bill_address.state} {e.bill_address.pin}</div>
                   </div>
