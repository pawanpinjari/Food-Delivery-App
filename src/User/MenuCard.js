...
const MenuCard = ({ menuData, restId }, props) => {
  ...
  const uniqueList = ['All', ...new Set(menuData.map(curElem => curElem.category))];
                  ...
                  <div className='card-menu'>
                    ...
                    <div className=''>
                      <div className='card-header'>
                        ...
                        <div className='menu-price subtile'>
                          <BiRupee />
                          {price}
                        </div>
                      </div>
                      ...
                      <div className=''>
                        <button className='menu-btn' onClick={() => onOrder(_id, name, price, image)}>
                          Add to Cart
                        </button>
                      </div>
                    </div>
